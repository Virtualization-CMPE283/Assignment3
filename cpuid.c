...
#define MAX_EXIT_REASONS 62
static const int max_exit_reasons = MAX_EXIT_REASONS;
static atomic_t exits;
static atomic_t exits_per_reason[MAX_EXIT_REASONS];
static atomic64_t exits_time;
static atomic64_t exit_time_per_reason[MAX_EXIT_REASONS];
...
EXPORT_SYMBOL_GPL(exits_time);
EXPORT_SYMBOL_GPL(exits_per_reason);
EXPORT_SYMBOL_GPL(exit_time_per_reason);
EXPORT_SYMBOL_GPL(max_exit_reasons);
...
EXPORT_SYMBOL_GPL(add_exit_for_reason);
EXPORT_SYMBOL_GPL(add_exit_time);
EXPORT_SYMBOL_GPL(add_exit_time_for_reason);
